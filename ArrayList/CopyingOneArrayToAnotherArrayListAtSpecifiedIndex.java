...
public class CopyingOneArrayToAnotherArrayListAtSpecifiedIndex {
    ...
    public static void main(String [] args)
    {
        ...
        System.out.println("============================================");
        System.out.println("After Adding first ArrayList at specified index  to the 2nd ArrayList:");
        System.out.println("============================================");
        
        // adding 1st ArrayList value to the 2nd ArrayList using addAll(int index ,Collection obj) at specified index
